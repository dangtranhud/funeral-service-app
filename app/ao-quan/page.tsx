import { ShoppingOutlined, CheckCircleOutlined, PhoneOutlined } from '@ant-design/icons'
      ...
      <section className="py-16 px-4 bg-zinc-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-zinc-500 mb-12">
            Tất cả sản phẩm đều đạt tiêu chuẩn chất lượng cao
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {products.map((p) => (
              <div key={p.id}
                className="bg-white rounded-2xl shadow-md p-8 hover:shadow-xl transition border border-zinc-100">
                <div className="flex items-center gap-3 mb-4">
                  <ShoppingOutlined className="text-3xl text-yellow-400" />
