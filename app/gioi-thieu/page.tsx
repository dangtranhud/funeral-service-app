  ...
  return (
    <div>
      <section className="bg-zinc-900 text-white py-20 px-4 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold mb-4">Giới Thiệu <span className="text-yellow-400">Funeral</span></h1>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            Funeral là đơn vị cung cấp dịch vụ tang lễ trọn gói hàng đầu tại TP. Hồ Chí Minh.
